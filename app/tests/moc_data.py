...
MOC_DATA_HOTELS = [
    {
        ...
        "services": ["Wi-Fi", "Парковка", "Тренажёрный зал"],
        "rooms_quantity": 55,
        "image_id": 4,
    },
    {
        ...
        "services": ["Wi-Fi", "Парковка", "Кондиционер в номере", "Тренажёрный зал"],
        "rooms_quantity": 45,
        "image_id": 6,
    },
    {
    ...
    },
    {
        ...
        "services": ["Wi-Fi", "Парковка", "Кондиционер в номере"],
        "rooms_quantity": 22,
        "image_id": 5,
    },
    {
...
MOC_DATA_ROOMS = [
    ...
    },
    {
        ...
        "price": 22450,
        "services": ["Бесплатный Wi‑Fi", "Кондиционер"],
        "quantity": 10,
        "image_id": 8,
    },
    {
...
MOC_DATA_TEST_MODEL = [
    {"name": "Test1", "image_id": 1},
    {"name": "Test2", "image_id": 1},
    {"name": "Test3", "image_id": 2},
    {"name": "Test4", "image_id": 1},
]
